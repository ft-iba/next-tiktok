...
import styles from './TiktokSlide.module.scss';
    ...
    >
      ...
      {(activeIndex === index || isLoaded) && (
        <iframe
          ...
          src={`https://www.tiktok.com/player/v1/${postId}?controls=0&progress_bar=0&play_button=0&volume_control=0&fullscreen_button=0&loop=1&rel=0&native_context_menu=0&closed_caption=0`}
